                                        ...
                                        <div class="border p-4 rounded-lg">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="passengers[<?= $I ?>][fullname]" class="w-full border rounded p-2" >
                                                </div>
                                                <div>
                        ...
                        <div class="border p-4 rounded-lg">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="contact[fullname]" class="w-full border rounded p-2" placeholder="VÍ DỤ: NGUYEN TUAN ANH" >
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1">Số điện thoại *</label>
                                    <input type="text" name="contact[phone]" class="w-full border rounded p-2" >
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1">Email *</label>
                                    <input type="email" name="contact[email]" class="w-full border rounded p-2" >
                                </div>
